...
const QUESTIONS_DB: Question[] = [
  ...
  // Unit 3: الكيمياء العضوية
  {
    ...
    lessonId: "u3_l1",
    type: "true_false",
    text: "حطم العالم ووهلر نظرية القوة الحيوية بتحضير اليوريا كأول مركب عضوي في المختبر.",
    correctAnswer: true,
    explanation: "حضر العالم فريدريك ووهلر اليوريا بتسخين سيانات الأمونيوم غير العضوية في المختبر عام 1828م.",
  },
  {
    id: "q_u3_tf2",
    unitId: "3",
    lessonId: "u3_l3",
    type: "true_false",
    text: "يعتبر غاز الإيثين من الهيدروكربونات المشبعة التي تحتوي على رابطة تساهمية ثلاثية.",
    correctAnswer: false,
    explanation: "الإيثين هيدروكربون غير مشبع (ألكين) يحتوي على رابطة ثنائية، بينما الألكاينات تحتوي على الرابطة الثلاثية.",
  },
  {
    id: "q_u3_fb1",
    unitId: "3",
  ...
  },
  {
    ...
    lessonId: "u3_l3",
    type: "fill_blank",
    text: "يحضر غاز الميثان في المختبر بالتقطير الجاف لملح ________ مع الجير الصودي.",
    correctAnswer: "أسيتات الصوديوم",
    explanation: "أسيتات الصوديوم اللامائية (CH3COONa) يتم تسخينها مع الصودا الكاوية بوجود الجير الحي لإنتاج غاز الميثان.",
  },
  {
    id: "q_u3_match1",
    unitId: "3",
    lessonId: "u3_l3",
    type: "match",
    title: "صل الصيغة البنائية للمركبات العضوية الهيدروكربونية باسمها الصحيح (IUPAC):",
    pairs: [
      { left: "CH4", right: "ميثان (أبسط الهيدروكربونات المشبعة)" },
      { left: "C2H4", right: "إيثين (يحتوي على رابطة تساهمية ثنائية)" },
      { left: "C2H2", right: "إيثاين (غاز الأسيتيلين المستخدم في لحام المعادن)" },
      { left: "C6H6", right: "البنزين العطري (المركب الأروماتي الحلقي المميز)" }
    ],

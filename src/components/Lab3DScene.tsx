  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* 🖐️ Floating Drag-and-Drop Hint (Only appears temporarily while user is actively dragging an item) */}
        {dragFeedback && (
          <div className="absolute top-14 left-1/2 -translate-x-1/2 z-20 pointer-events-none max-w-lg w-[90%] text-center">
            <div className="bg-emerald-950/90 backdrop-blur-md px-3.5 py-1.5 rounded-xl border border-emerald-400 text-emerald-200 text-xs font-bold shadow-2xl inline-flex items-center justify-center gap-2 animate-bounce">
